<?
$my=mysql_query("SELECT * FROM `admins_page` WHERE ids_razdel='$roditel' && ids_podrazdel<>'1' ORDER BY ids_podrazdel;");
if (mysql_num_rows($my)==true)
{
?>
<tr bgcolor="F8FAFC">
	<td height="25" valign="top" class="blue1"><div align="right"><strong>Существующие<br>
		подразделы</strong></div></td>
	<td  class="blue1">
