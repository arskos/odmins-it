...
<tr>
	<td width="16%"><a href="admin.php?article=yes&article_add=yes"><img src="imgadm/b_add.gif" width="20" height="20" border="0"></a></td>
	<td width="84%"><a href="admin.php?article=yes&article_add=yes" class="blue1">Добавить новую статью</a></td>
</tr>
<tr>
...
<tr>
	...
	<?
		...
		{if ($key==="Article_show"){echo $value;}}
	?>
	</div></td>
</tr>
<tr>
