...
<tr class="blue1">
	...
	<td width="30%" background="imgadm/mm_top2.gif" class="blue1">Название</td>
	<td width="45%" background="imgadm/mm_top2.gif" class="blue1">Анонс</td>
...
<?} else {?><tr onMouseOver="this.bgColor = '#EFF3F7'" onMouseOut ="this.bgColor = '#F8FAFC'" bgcolor="F8FAFC"><?}?>
		...
		<td><div align="center"><a href="admin.php?article=yes&article_edit=yes&article_ids=<?echo $main['id'];?>"><img src="imgadm/b_edit.gif" alt="Редактировать" width="20" height="20" border="0"></a></div></td>
		<td ><div align="center"><a href="#" onClick=answer_article(<?echo $main['id'];?>)><img src="imgadm/b_del.gif" alt="Удалить" width="20" height="20" border="0"></a></div></td>
		<td ><div align="center">
...
<tr>
	<td height="21" colspan="7" bgcolor="EFEFEF" class="blue1">
		...
		<tr>
			...
			<td width="573"><a href="#" class="blue1" onClick=querys_article()>удалить все выделенные </a></td>
