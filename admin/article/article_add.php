...
<tr>
	...
	<td bgcolor="F8FAFC" class="blue1">
		<textarea name="article_full" rows="8" class="fld" style="width:100%" onBlur="mag(document.article_add.article_full.value);"><?echo unhtmlentities($postedValue);?></textarea>
		<br>
		<input type="hidden" name="article_add_vis" value="yes">
...
<form name="article_add_save" action="admin.php" method="post">
	<input type="hidden" name="article_add_ok" value="yes">
	<input type="hidden" name="article_post" value="yes">
