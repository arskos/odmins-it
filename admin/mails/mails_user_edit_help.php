...
<tr>
	<td width="16%" align="right"><a href="javascript: document.mails_user_add.submit();" onClick="mails_mag();"><img src="imgadm/b_save.gif" width="20" height="20" border="0"></a></td>
	<td width="84%"><a href="javascript: document.mails_user_add.submit();" onClick="mails_mag();" class="blue1">Сохранить</a></td>
</tr>
<tr>
...
<tr>
	...
	<?
		...
		{if ($key==="Mails_user_edit"){echo $value;}}
	?>			
		</div>
	</td>
</tr>
