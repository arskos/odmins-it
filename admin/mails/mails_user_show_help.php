...
<tr>
	<td width="16%"><a href="admin.php?mails=yes&mails_user_add=yes"><img src="imgadm/b_add.gif" width="20" height="20" border="0"></a></td>
	<td width="84%"><a href="admin.php?mails=yes&mails_user_add=yes" class="blue1">Добавить подписчика </a></td>
</tr>
<tr>
...
<tr>
	...
	<?
		...
		{if ($key==="Mails_user_show"){echo $value;}}
	?>	
	</div></td>
</tr>
<tr>
