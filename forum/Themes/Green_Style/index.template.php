...
<div id="wrapper" style="width: ' . $settings['forum_width'] . '">' : '', '
	<div id="header"><div class="frame">
		<div id="top_section">
			<h1 class="forumtitle">
				<a href="', $scripturl, '"><img src="' . $settings['theme_url']. '/images/theme/logo.png" alt="' . $context['forum_name'] . '" />', '</a>
			</h1>';
...
function template_body_below()
{
	...
	<div id="footer_section"><div class="frame">
		<ul class="reset">
			...
			<li><a href="http://www.skinmod.es/" target="_blank"><span>Green Style by kenet</span></a></li>
