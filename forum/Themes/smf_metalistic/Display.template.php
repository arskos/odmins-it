...
<table cellpadding="3" cellspacing="0" border="0" width="100%" class="tborder">
	<tr class="titlebg">
		<td colspan="2" valign="middle" class="tborder" style="border-width: 0 0 1px 0;" align="left" style="padding-left: 6px;">
		...
		<td align="left" class="windowbg2" width="100%">
			<table cellpadding="3" cellspacing="0" width="100%">
				<tr>
					...
					<td align="right" valign="middle" style="font-size: smaller;">';
