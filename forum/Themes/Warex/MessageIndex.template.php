...
function template_main()
{
	...
	if (!empty($context['boards']) && (!empty($options['show_children']) || $context['start'] == 0))
	{
		echo '
	<a name="top"></a>
	<div class="categoryframe" style="margin-top:-5px;">
			<div class="alt">
			<div class="alt-r">
				<div class="alt-l"><h3 style="color:#ffffff;">
...
<div class="wrapper">
	...
	<div class="block_5">
		<p style="padding-left:25%;padding-top:11px;">';
	...
	<div class="block_7">
		<p style="padding-left:8px;padding-top:11px;">';
				...
				if (!empty($board['last_post']['id']))
					...
					echo '<strong>', $txt['last_post'], '</strong>	', $txt['by'], '<font style="color:#000000;"> ', $board['last_post']['member']['link'] , '</font><br />', $txt['in'], '  ', $board['last_post']['link'], '<br />', $txt['on'], ' ', $board['last_post']['time'], '';
echo'
		</p>
	</div>
</div>';
	...
	<form action="', $scripturl, '?action=quickmod;board=', $context['current_board'], '.', $context['start'], '" method="post" accept-charset="', $context['character_set'], '" name="quickModForm" id="quickModForm">';
		...
		foreach ($context['topics'] as $topic)
		{
			...
			echo '
							...
							<td class="windowbg2' , $topic['is_sticky'] ? '3' : '' , ' views">
								', $topic['views_link'], '
							</td>
							<td class="windowbg lastpost">
