...
<div id="events" class="tborder marginbottom margintop">
	...
	$normal_buttons = array(
		...
		'tvl_title' => array('test' => 'can_view_topic_log', 'text' => 'tvl_title', 'image' => 'topiclog.gif', 'lang' => true, 'url' => $scripturl . '?action=topicviewlog;topic=' . $context['current_topic'] . '.0'),
	);
...
<div class="clearfix margintop" id="postbuttons">
  ...
  <div class="d">
			 <div class="dright">
				<div class="dleft">  
 <h3 style="font-size:115%;color:#ffffff;font-weight:bold;padding-top:0px;padding-left:10px;padding-right:40px;">
		<img src="', $settings['images_url'], '/topic/', $context['class'], '.gif" align="bottom" alt="" />
			  <span id="top_subject">', $txt['topic'], ': ', $context['subject'], '  (', $txt['read'], ' ',  $context['num_views'], ' ', $txt['times'], ')</span>
	</h3>
 
			</div></div></div><div class="catwrapleft">
<div class="catwrapright">
<div id="forumposts" class="tborder" style="margin-top:-10px;">
...
';
	...
	while ($message = $context['get_message']())
	{
		...
		echo '
			<div class="clearfix ', !$is_first_post ? 'topborder ' : '', $message['approved'] ? ($message['alternate'] == 0 ? 'windowbg' : 'windowbg2') : 'approvebg', ' largepadding1">';

		// Show information about the poster of this message.
		echo '
	<div class="floatleft poster">
<div class="profilust" style="text-align:center;">
			 <div class="profilsol">
				<div class="profilsag1">
			

				  ', $message['member']['link'], '</div></div></div>  <div class="profilmid">
				<div class="profilsagkenar">
<div class="profilsolkenar"> <center>  <ul class="smalltext" id="msg_', $message['id'], '_extra_info">';
		...
		// Show avatars, images, etc.?
				if (!empty($settings['show_user_images']) && empty($options['show_no_avatars']) && !empty ($message['member']['avatar']['image'])) echo ' <li class="margintop" style="overflow: auto;">', $message['member'] ['avatar']['image'], '</li>';  
if (!empty($settings['show_user_images']) && empty($options['show_no_avatars']) && empty($message['member']['avatar'] ['image'])) echo ' <li class="margintop" style="overflow: auto;"><img src="', $settings['images_url'], '/avatar.gif" alt=""  /></li>';  
		...
		echo '
		  ...
		  <div class="profilalt">
			 <div class="profilsolalt">
				<div class="profilsagalt">
			</div></div></div></div>
			<div class="postarea">
...
<div class="clearfix marginbottom" id="postbuttons_lower">
	...
	echo '
<div id="moderationbuttons" class="clearfix mred floatleft"   style="margin-top:-16px;padding-left:10px;">', template_button_strip($mod_buttons, 'bottom', array('id' => 'moderationbuttons_strip')), '</div>';
...
<div class="catwrapright"><div class="tborder">
