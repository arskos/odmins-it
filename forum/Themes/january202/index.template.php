	 ...
	 <div id="footer">
		 <div id="foot-l">
			 <div id="foot-r">
				...
				<div class="left"><b>January</b> 2009, by <a href="http://www.jpr62.com" title=""  target="_blank">Crip</a>
		  </div>';
	...
	echo '
		<div id="nav">
			...
			foreach ($context['menu_buttons'] as $act => $button)
				echo '<li><a ', $button['active_button'] ? ' class="chosen_menu"' : '' , ' href="', $button['href'], '">', $button['title'], '</a></li>';
