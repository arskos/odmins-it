	...
	echo '
				...
				<tr class="catbg">
					<td colspan="2"><img src="', $settings['images_url'], '/icons/config_sm.gif" alt="" align="top" /> ', $txt['theme6'], '</td>
                               ...
                               <tr class="windowbg2">
                                        <td>htmlbox : (use your own HTML code)</td><td><textarea cols="70" rows="5" name="options[topbar]">' , isset($context['theme_settings']['topbar']) ? $context['theme_settings']['topbar'] : '' , '</textarea></td>
                                </tr>
                               <tr class="windowbg2">
                                        <td>align content in htmlbox:</td><td>
                                                    <input type="radio" name="options[topbaralign]" ' , (!isset($context['theme_settings']['topbaralign']) || (isset($context['theme_settings']['topbaralign']) && $context['theme_settings']['topbaralign']=='left')) ? 'checked=checked""' : '' , ' value="left"  /> Left<br />
                                                    <input type="radio" name="options[topbaralign]" ' , (isset($context['theme_settings']['topbaralign']) && $context['theme_settings']['topbaralign']=='center') ? 'checked=checked""' : '' , ' value="center"  /> Center<br />
                                                    <input type="radio" name="options[topbaralign]" ' , (isset($context['theme_settings']['topbaralign']) && $context['theme_settings']['topbaralign']=='right') ? 'checked=checked""' : '' , ' value="right"  /> Right<br />
                                        </td>
                                </tr>
                                  <tr class="windowbg2"><td colspan="2"><hr size="1" /></td></tr>';
