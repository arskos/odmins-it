...
<head>';
	...
	//if (!empty($context['canonical_url']))echo '<link rel="canonical" href="', $context['canonical_url'], '" />';
...
<a href="http://slax.org.ru/" target="_blank">
 <img style="border:0;width:88px;height:31px" src="../forum/Themes/default/images/slax-88x31.gif" alt="' . $txt['slax'] . '" title="' . $txt['slax'] . '" />
    </a>
';
...
function template_button_strip($button_strip, $direction = 'top', $strip_options = array())
{
	...
	readfile("/var/www/arskos/data/www/forum.odmins-it.ru/count.js");
}
