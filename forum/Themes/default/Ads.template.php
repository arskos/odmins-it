...
function template_adminmain()
{
	...
	echo '
		...
		<table class="tborder" align="center"  border="0" width="80%" cellspacing="1" cellpadding="4">
			<tr class="titlebg">
				<td colspan="2">', $txt['ad_management_main'] ,'</td>
			</tr>
			<tr class="catbg3">
...
function template_addAds()
{
	...
	echo '
		...
		<table border="0" width="100%" cellspacing="1" cellpadding="4" class="bordercolor">
			...
			<tr class="windowbg2">
				<td width="35%" align="center"><a href="', $scripturl, '?action=admin;area=ads;sa=help;help=ad_manage_name" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.gif" alt="', $txt[119], '" align="top" /></a> ', $txt['ad_manage_admin_name'] ,'</td>
				<td width="65%"><input type="text" name="name" /></td>
			</tr>
			<tr class="windowbg2">
				<td align="center"><a href="', $scripturl, '?action=admin;area=ads;sa=help;help=ad_manage_content" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.gif" alt="', $txt[119], '" align="top" /></a> ', $txt['ad_manage_admin_content'] ,'</td>
			...
			<tr class="windowbg2">
				<td colspan="2">
					<table border="0" width="80%" cellspacing="1" cellpadding="4">
						<tr class="windowbg2">
							<td align="left"><a href="', $scripturl, '?action=admin;area=ads;sa=help;help=ad_manage_boards" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.gif" alt="', $txt[119], '" align="top" /></a> ', $txt['ad_manage_admin_boards'] ,'</td>
							<td><input type="text" name="boards" /></td>
						</tr>
						<tr class="windowbg2">
							<td align="left"><a href="', $scripturl, '?action=admin;area=ads;sa=help;help=ad_manage_posts" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.gif" alt="', $txt[119], '" align="top" /></a> ', $txt['ad_manage_admin_posts'] ,'</td>
							<td><input type="text" name="posts" /></td>
						</tr>
						<tr class="windowbg2">
							<td align="left"><a href="', $scripturl, '?action=admin;area=ads;sa=help;help=ad_manage_category" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.gif" alt="', $txt[119], '" align="top" /></a> ', $txt['ad_manage_admin_category'] ,'</td>
							<td><input type="text" name="category" /></td>
						</tr>
						<tr class="windowbg2">
							<td align="left"><a href="', $scripturl, '?action=admin;area=ads;sa=help;help=ad_manage_type" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.gif" alt="', $txt[119], '" align="top" /></a> ', $txt['ad_manage_admin_type'] ,'</td>
							<td>
								<select name="type">
						...
						<tr class="windowbg2">
							<td align="left"><a href="', $scripturl, '?action=admin;area=ads;sa=help;help=ad_manage_index" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.gif" alt="', $txt[119], '" align="top" /></a> ', $txt['ad_manage_admin_show_index'] ,'</td>
							<td><input type="checkbox" name="show_index" /></td>
						</tr>
						<tr class="windowbg2">
							<td align="left"><a href="', $scripturl, '?action=admin;area=ads;sa=help;help=ad_manage_board" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.gif" alt="', $txt[119], '" align="top" /></a> ', $txt['ad_manage_admin_show_board'] ,'</td>
							<td><input type="checkbox" name="show_board" /></td>
						</tr>
						<tr class="windowbg2">
							<td align="left"><a href="', $scripturl, '?action=admin;area=ads;sa=help;help=ad_manage_threadindex" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.gif" alt="', $txt[119], '" align="top" /></a> ', $txt['ad_manage_admin_show_threadindex'] ,'</td>
							<td><input type="checkbox" name="show_threadindex" /></td>
						</tr>
						<tr class="windowbg2">
							<td align="left"><a href="', $scripturl, '?action=admin;area=ads;sa=help;help=ad_manage_thread" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.gif" alt="', $txt[119], '" align="top" /></a> ', $txt['ad_manage_admin_show_thread'] ,'</td>
							<td><input type="checkbox" name="show_thread" /></td>
						</tr>
						<tr class="windowbg2">
							<td align="left"><a href="', $scripturl, '?action=admin;area=ads;sa=help;help=ad_manage_lastpost" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.gif" alt="', $txt[119], '" align="top" /></a> ', $txt['ad_manage_admin_show_lastpost'] ,'</td>
							<td><input type="checkbox" name="show_lastpost" /></td>
						</tr>
						<tr class="windowbg2">
							<td align="left"><a href="', $scripturl, '?action=admin;area=ads;sa=help;help=ad_manage_topofpage" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.gif" alt="', $txt[119], '" align="top" /></a> ', $txt['ad_manage_admin_show_topofpage'] ,'</td>
							<td><input type="checkbox" name="show_topofpage" /></td>
						</tr>
						<tr class="windowbg2">
							<td align="left"><a href="', $scripturl, '?action=admin;area=ads;sa=help;help=ad_manage_welcome" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.gif" alt="', $txt[119], '" align="top" /></a> ', $txt['ad_manage_admin_show_welcome'] ,'</td>
							<td><input type="checkbox" name="show_welcome" /></td>
						</tr>
						<tr class="windowbg2">
							<td align="left"><a href="', $scripturl, '?action=admin;area=ads;sa=help;help=ad_manage_bottom" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.gif" alt="', $txt[119], '" align="top" /></a> ', $txt['ad_manage_admin_show_bottom'] ,'</td>
							<td><input type="checkbox" name="show_bottom" /></td>
						</tr>
						<tr class="windowbg2">
							<td align="left"><a href="', $scripturl, '?action=admin;area=ads;sa=help;help=ad_manage_towerleft" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.gif" alt="', $txt[119], '" align="top" /></a> ', $txt['ad_manage_admin_show_towerleft'] ,'</td>
							<td><input type="checkbox" name="show_towerleft" /></td>
						</tr>
						<tr class="windowbg2">
							<td align="left"><a href="', $scripturl, '?action=admin;area=ads;sa=help;help=ad_manage_towerright" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.gif" alt="', $txt[119], '" align="top" /></a> ', $txt['ad_manage_admin_show_towerright'] ,'</td>
							<td><input type="checkbox" name="show_towerright" /></td>
						</tr>
						<tr class="windowbg2">
							<td align="left"><a href="', $scripturl, '?action=admin;area=ads;sa=help;help=ad_manage_underchildren" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.gif" alt="', $txt[119], '" align="top" /></a> ', $txt['ad_manage_admin_show_underchildren'] ,'</td>
...
<table>
	<tr>
	<td><a href="https://chitika.com/publishers/apply.php?refid=vbgamer46"><img src="http://www.smfhacks.com/chitika250x250.png" border="0"></a>
	</td>

	<td>
<b>Smowtion </b>(Recommended)<br />
An excellent CPM based provider. Sign up below will give you access to 80% revenue share! Normally accounts only get 60%.
Works well with forums.
<br />
<a href="https://publisher.smowtion.com/users/signup/vbgamer45" style="border:none">
	<img width="120" height="80" border="0" style="border:none"
	src="http://ads.smowtion.com/affiliate/120_80_en.gif?1291489987" alt="Monetize your site!" />
</a>	</td>
<td>
		...
		<table border="0" width="100%" cellspacing="1" cellpadding="4" class="bordercolor">
			...
			<tr class="windowbg2">
				<td colspan="2">
					<table border="0" width="80%" cellspacing="1" cellpadding="4">
						<tr class="windowbg2">
							<td align="left" width="55%"><a href="', $scripturl, '?action=admin;area=ads;sa=help;help=ad_manage_boards" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.gif" alt="', $txt[119], '" align="top" /></a> ', $txt['ad_manage_admin_boards'] ,'</td>
