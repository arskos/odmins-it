...
$txt['add_spider_desc'] = 'На этой странице Вы можете изменять параметры пауков. Если user agent / IP адрес гостя будут совпадать с введенными ниже, то он будет опознан как паук поисковой системы и действия его будут записаны согласно настройкам форума.';
