...
$txt['membergroups_description'] = 'Группы пользователей имеют определенные параметры настройки и свои права доступа. Некоторые группы зависят от количества сообщений. Вы можете назначить нужную группу пользователю, зайдя в его профиль и изменив настройки учетной записи.';
...
$txt['membergroups_edit_hidden_warning'] = 'Вы уверены, что хотите запретить назначение этой группы в качестве основной? \\n\\nЭто ограничит назначение группы только в качестве дополнительной.';
...
$txt['admin_browse_approve_desc'] = 'Здесь можно управлять всеми пользователями, учетные записи которых ожидают одобрения.';
