...
$txt['scheduled_task_desc_fetchSMfiles'] = 'Скачивание javascript файлов, содержащих уведомления об обновлениях (и другую информацию).';
$txt['scheduled_task_birthdayemails'] = 'Отправка поздравлений с днем рождения';
$txt['scheduled_task_desc_birthdayemails'] = 'Рассылка по электронным адресам пользователей поздравлений с днем рождения.';
