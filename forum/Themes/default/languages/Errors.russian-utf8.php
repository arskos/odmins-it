...
$txt['cannot_profile_title_own'] = 'Вы не можете изменить надпись над аватаром в Вашем профиле.';
...
// KeyCAPTCHA for SMF
$txt['error_wrong_keycaptcha'] = 'Задание выполнено неверно. Пожалуйста, прочтите инструкцию и попробуйте снова.';
...
$txt['mc_no_modreport_found'] = 'Выбранный отчет не существует или у Вас нет прав на просмотр.';
