...
// Categories
$txt['manual_category_getting_started'] = '新手上路';
$txt['manual_category_registering'] = '註冊';
$txt['manual_category_profile_features'] = '個人資料';
$txt['manual_category_posting_basics'] = '發表功能';
$txt['manual_category_personal_messages'] = '簡訊功能';
$txt['manual_category_forum_tools'] = '論壇工具';
$txt['manual_category_reference'] = '參考資訊';

// Sections
$txt['manual_section_intro'] = '前言';
$txt['manual_section_main_menu'] = '主選單';
$txt['manual_section_board_index'] = '看板列表';
$txt['manual_section_message_view'] = '文章列表';
$txt['manual_section_topic_view'] = '主題檢視';
$txt['manual_section_when_how_register'] = '何時何地開始註冊';
$txt['manual_section_registration_screen'] = '註冊畫面';
$txt['manual_section_activating_account'] = '啟用帳號';
$txt['manual_section_logging_in_out'] = '登入與登出';
$txt['manual_section_password_reminders'] = '密碼提示';
$txt['manual_section_profile_info'] = '個人資料';
$txt['manual_section_modify_profile'] = '修改個人資料';
$txt['manual_section_profile_actions'] = '執行動作';
$txt['manual_section_posting_screen'] = '發表畫面';
$txt['manual_section_posting_topics'] = '文章, 投票和活動';
$txt['manual_section_quoting_posts'] = '引用文章';
$txt['manual_section_modifying_posts'] = '修改與移除文章';
$txt['manual_section_smileys'] = '表情符號';
$txt['manual_section_bbcode'] = 'BB碼';
$txt['manual_section_wysiwyg'] = '所見即所得編輯器';
$txt['manual_section_pm_messages'] = '簡訊';
$txt['manual_section_pm_actions'] = '更多動作';
$txt['manual_section_pm_preferences'] = '偏好設定';
$txt['manual_section_searching'] = '搜尋';
$txt['manual_section_memberlist'] = '會員列表';
$txt['manual_section_calendar'] = '日曆';

// Entries
$txt['manual_entry_profile_info_desc'] = '這兒提供了關於檢視會員個人資料的資訊。';
$txt['manual_entry_profile_info_summary'] = '個人名片';
$txt['manual_entry_profile_info_posts'] = '顯示文章';
$txt['manual_entry_profile_info_stats'] = '資料統計';
$txt['manual_entry_profile_actions_desc'] = '這兒提供了關於一些帳戶動作的資訊。';
$txt['manual_entry_modify_profile_settings'] = '帳戶設定';
$txt['manual_entry_modify_profile_forum'] = '論壇資料';
$txt['manual_entry_modify_profile_look'] = '佈景與外觀';
$txt['manual_entry_modify_profile_auth'] = '帳號驗證';
$txt['manual_entry_modify_profile_notify'] = '通知設定';
$txt['manual_entry_modify_profile_pm'] = '簡訊設定';
$txt['manual_entry_modify_profile_ignore_boards'] = '忽視看板設定';
$txt['manual_entry_modify_profile_buddies'] = '好友壞人名單';
$txt['manual_entry_modify_profile_groups'] = '群組身份';
$txt['manual_entry_profile_actions_subscriptions'] = '付費訂購';
$txt['manual_entry_profile_actions_delete'] = '刪除這帳戶';

// Text for template: index
$txt['manual_index_visit_simple_machines'] = '前往 Simple Machines 官網！';
$txt['manual_index_intro'] = '前言';
$txt['manual_index_register'] = '註冊';
$txt['manual_index_login'] = '登入';
$txt['manual_index_profile'] = '個人資料';
$txt['manual_index_posting'] = '發表文章';
$txt['manual_index_pm'] = '簡訊';
$txt['manual_index_search'] = '搜尋';

// Text for template: smf
$txt['manual_smf_user_help'] = 'SMF 使用者幫助';

// Text for template: intro
$txt['manual_intro_welcome_to'] = '歡迎來到';
$txt['manual_intro_welcome_after'] = ', 是使用論壇軟體';
$txt['manual_intro_smf_link'] = 'Simple Machines Forum';
$txt['manual_intro_smf_abbreviation'] = '(SMF) 架設的！';
...
$txt['manual_board_index_category_name'] = '類別名稱';
$txt['manual_board_index_external'] = '這看板重導向至一個外部地址。';
$txt['manual_board_index_num_redirects'] = '重導向次數';
$txt['manual_board_index_board_name'] = '看板名稱';
$txt['manual_board_index_child_boards'] = '子看板';
$txt['manual_board_index_child'] = '子看板';
$txt['manual_board_index_board_discuss'] = '看板簡介';
$txt['manual_board_index_posts_topics'] = '文章數目和主題數目';
$txt['manual_board_index_dtsa'] = '最後一篇文章的日期, 時間, 題目, 和作者';
$txt['manual_board_index_board_mod'] = '板主';
$txt['manual_board_index_redirects'] = '重導向';
...
$txt['manual_message_index_pages'] = '頁: [<strong>頁碼</strong>]';
$txt['manual_message_index_sticky_topic'] = '這是一篇被置頂的主題。';
$txt['manual_message_index_started_by'] = '作者';
$txt['manual_message_index_num_replies'] = '回覆數';
$txt['manual_message_index_num_views'] = '閱讀次數';
$txt['manual_message_index_dta'] = '日期, 時間和最後發表的作者';
$txt['manual_message_index_normal_topic'] = '這是一篇普通的主題。';
$txt['manual_message_index_locked_topic'] = '這是一篇被鎖定的主題。';
...
$txt['manual_topic_looks'] = '一篇主題通常都是這個樣子:';
$txt['manual_topic_subject'] = '標題';
$txt['manual_topic_heading'] = '題目: 主題題目  (x 次觀看)';
$txt['manual_topic_post_author'] = '作者';
$txt['manual_topic_custom_title'] = '自訂頭銜';
$txt['manual_topic_membergroup'] = '會員群組';
$txt['manual_topic_post_group'] = '文章數群組';
$txt['manual_topic_post_count'] = '文章數: 已經發表的文章數量';
$txt['manual_topic_post'] = '文章的題目';
$txt['manual_topic_dt'] = '<strong>於:</strong> 發表日期和時間';
$txt['manual_topic_body'] = '這是文章的內文, 也就是我們來這兒的原因!';
$txt['manual_topic_signature'] = '簽名檔';
...
$txt['manual_register_form'] = '註冊表單';
$txt['manual_register_required_info'] = '必填的資訊';
$txt['manual_register_username'] = '帳號';
$txt['manual_register_email'] = 'Email';
$txt['manual_register_email_allow'] = '允許會員 Email 給我';
$txt['manual_register_auth_method'] = '認證方法';
$txt['manual_register_password'] = '密碼';
$txt['manual_register_openid'] = 'OpenID';
$txt['manual_register_password_choose'] = '輸入密碼';
$txt['manual_register_password_verify'] = '確認密碼';
$txt['manual_register_openid_auth'] = 'OpenID 認證網址';
$txt['manual_register_verification'] = '驗證碼';
$txt['manual_register_type_letters'] = '輸入圖片上的文字';
$txt['manual_register_listen_letters'] = '播放文字聲音';
$txt['manual_register_request_image'] = '換張圖片';
$txt['manual_register_question'] = '現存甚麼論壇軟件最好?';
$txt['manual_register_register'] = '註冊';
...
$txt['manual_loginout_login_screen'] = '登入畫面';
$txt['manual_loginout_quick_login'] = '快速登入';
$txt['manual_loginout_logging_out'] = '登出';
...
$txt['manual_loginout_login_lower'] = '登入';
$txt['manual_loginout_register'] = '註冊';
$txt['manual_loginout_hour'] = '1 小時';
$txt['manual_loginout_day'] = '1 日';
$txt['manual_loginout_week'] = '1 星期';
$txt['manual_loginout_month'] = '1 月';
...
$txt['manual_reminders_continue'] = '繼續';
...
$txt['manual_pm_delete_selected'] = '移除選擇';
