...
$helptxt['disableSubjectChange'] = 'With this option enabled, members will no longer be able to change the subject of a topic when replying. Admins and moderators are exempt, meaning they still can modify the subject.';
...
$helptxt['tp_full_ads'] = 'Tapatalk will show a one-time welcome screen to mobile web users informing them to download and view your forum in the free app. This screen will contain your forum branding only along with a download button.';
$helptxt['tp_full_banner'] = 'Tapatalk will show a smart banner to mobile users, when your forum is viewed by a mobile web browser. The smart banner will contain two buttons: "Open in app" and "Install".';
//Tapatalk IAR
