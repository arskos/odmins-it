...
$txt['manual_category_registering'] = 'Se înregistrează';
$txt['manual_category_profile_features'] = 'Caracteristici Profil';
$txt['manual_category_posting_basics'] = 'Noţiuni de bază privind postarea';
$txt['manual_category_personal_messages'] = 'Mesaje Private';
$txt['manual_category_forum_tools'] = 'Unelte Forum';
$txt['manual_category_reference'] = 'Referinţă';

// Sections
$txt['manual_section_intro'] = 'Introducere';
$txt['manual_section_main_menu'] = 'Meniul Principal';
...
$txt['manual_section_when_how_register'] = 'Când şi cum vă înregistraţi';
$txt['manual_section_registration_screen'] = 'Ecranul de înregistrare';
$txt['manual_section_activating_account'] = 'Activarea unui cont nou';
$txt['manual_section_logging_in_out'] = 'Logging In and Out';
$txt['manual_section_password_reminders'] = 'Reamintire Parolă';
$txt['manual_section_profile_info'] = 'Informaţii Profil';
$txt['manual_section_modify_profile'] = 'Modificare Profil';
$txt['manual_section_profile_actions'] = 'Acţiuni';
$txt['manual_section_posting_screen'] = 'Ecranul de Postare';
$txt['manual_section_posting_topics'] = 'Posting Topics, Polls and Events';
$txt['manual_section_quoting_posts'] = 'Citare mesaje postate';
$txt['manual_section_modifying_posts'] = 'Modificarea şi Ştergerea Mesajelor Postate';
$txt['manual_section_smileys'] = 'Emoticoane';
$txt['manual_section_bbcode'] = 'Bulletin Board Code';
$txt['manual_section_wysiwyg'] = 'Editorul WYSIWYG';
$txt['manual_section_pm_messages'] = 'Mesaje';
$txt['manual_section_pm_actions'] = 'Acţiuni';
$txt['manual_section_pm_preferences'] = 'Preferinţe';
$txt['manual_section_searching'] = 'Căutare';
$txt['manual_section_memberlist'] = 'Listă de Membri';
...
$txt['manual_entry_profile_info_summary'] = 'Sumar';
$txt['manual_entry_profile_info_posts'] = 'Afişează Mesajele Postate';
$txt['manual_entry_profile_info_stats'] = 'Afişează Statisticile';
...
$txt['manual_entry_modify_profile_settings'] = 'Setări Cont';
$txt['manual_entry_modify_profile_forum'] = 'Profil pe Forum';
$txt['manual_entry_modify_profile_look'] = 'Look and Layout';
$txt['manual_entry_modify_profile_auth'] = 'Autentificare';
$txt['manual_entry_modify_profile_notify'] = 'Notificări';
$txt['manual_entry_modify_profile_pm'] = 'Mesagerie Privată';
$txt['manual_entry_modify_profile_ignore_boards'] = 'Ignore Boards Options';
$txt['manual_entry_modify_profile_buddies'] = 'Lista de Amici / Ignorat ';
$txt['manual_entry_modify_profile_groups'] = 'Group Membership';
$txt['manual_entry_profile_actions_subscriptions'] = 'Abonamente Plătite';
$txt['manual_entry_profile_actions_delete'] = 'Şterge acest cont';
...
$txt['manual_index_pm'] = 'Mesaj Privat';
$txt['manual_index_search'] = 'Căutare';

// Text for template: smf
$txt['manual_smf_user_help'] = 'Ajutor SMF pentru Utilizatori';
...
$txt['manual_register_verification'] = 'Verificare';
...
$txt['manual_loginout_or'] = 'sau';
$txt['manual_loginout_minutes'] = 'Minutes to stay logged in';
$txt['manual_loginout_always'] = 'Rămâi mereu autentificat';
...
$txt['manual_loginout_forever'] = 'Pentru totdeauna';
...
$txt['manual_profile_delete_yes'] = 'Da';
...
$txt['manual_pm_community'] = 'SMF se referă la ideea de comunitate şi comunicare. Există multe modalităţi de a comunica, cum ar fi: postarea de mesaje în secţiuni, mesageria privată, e-mail, ICQ, AIM si YIM. Sistemul intern de mesagerie privată al SMF însă, asa cum este disponibil utilizatorilor înregistraţ în majoritatea forumurilor, este uneori o opţiune mai potrivită decât oricare dintre acestea.';
$txt['manual_pm_sec_pm'] = 'Mesageria Privată';
$txt['manual_pm_pm_desc'] = 'Descriere';
$txt['manual_pm_pm_desc_1'] = 'În timp ce email-ul este o modalitate bună de a coresponda direct cu membrii, acesta are, de asemenea, mai multe dezavantaje în raport cu scopul forumului: trebuie să deschidezi aplicaţia ta de e-mail pentru a scrie si trimite mesajul, destinatarul trebuie să deschidă aplicaţia sa de e-mail pentru a-şi verifica mesajele de e-mail, mesajul tău va fi amestecat cu toate celelalte mesaje de e-mail şi, uneori, poate dura de la câteva minute la o oră pentru ca un mesaj de e-mail să ajungă la destinatar.';
$txt['manual_pm_pm_desc_2'] = 'Ca o alternativă la e-mail, SMF oferă o metodă mult mai rapidă şi mai personală. Mesageria privată permite expedierea instantanee de mesaje în căsuţa de mail privată a destinatarului. Mesajul de e-mail este trimis şi primit integral prin SMF astfel încât nici tu, nici destinatarul nu trebuie să deschideţi alte aplicaţii sau să părăsiţi SMF. Mesageria privată oferă atât expeditorului, cât şi destinatarului, o mai mare discreţie întrucât nu este expusă nicio adresă de email reală. Mesageria privată doar manevrează mesajele în numele ambelor părţi.';
$txt['manual_pm_pm_desc_3'] = 'Dacă destinatarul nu este online, mesajele private aşteaptă în căsuţa personală până când acesta se autentifică, le citeşte şi/sau le ştearge. Mesageria Privată a SMF este un sistem de e-mail auto-controlat şi foarte discret.';
$txt['manual_pm_reading'] = 'Citirea Mesajelor Tale';
$txt['manual_pm_reading_desc_part1'] = 'Pentru a-ţi citi mesajele private trebuie să fii';
$txt['manual_pm_reading_desc_link_loginout'] = ' autentificat';
$txt['manual_pm_reading_desc_part2'] = ', apoi să urmeazi link-ul care spune ceva de genul \'Salut, [numele de utilizator], ai ';
$txt['manual_pm_reading_desc_link_loginout_interface'] = ' x mesaje';
$txt['manual_pm_reading_desc_part3'] = ', x sunt noi\'. ';
$txt['manual_pm_sec_pm2'] = 'Interfaţa unui Mesaj Privat';
$txt['manual_pm_pm_desc2_part1'] = 'Interfaţa unui Mesaj Privat, este similară în operare cu ';
$txt['manual_pm_pm_desc2_link_index_message'] = 'indexul de mesaje';
$txt['manual_pm_pm_desc2_part2'] = '. În timp ce noi îţi prezentăm interfaţa cu mesajele primite, cea cu mesaje trimise funţionează în acelaşi mod :';
$txt['manual_pm_forum_name'] = 'Denumire Forum';
$txt['manual_pm_personal_msgs'] = 'Mesaje Private';
...
$txt['manual_pm_check_new_msgs'] = 'Verificare mesaje noi';
$txt['manual_pm_date'] = 'Data';
$txt['manual_pm_subject2'] = 'Subiect';
$txt['manual_pm_from'] = 'De la';
$txt['manual_pm_date_and_time'] = 'Data şi ora mesajului';
$txt['manual_pm_another_member'] = 'Alt Membru';
$txt['manual_pm_subject'] = 'Subiectul Mesajului';
$txt['manual_pm_delete_selected'] = 'Ştergeţi cele selectate';
$txt['manual_pm_pages'] = 'Pagini';
$txt['manual_pm_nav_tree'] = 'Unele forumuri afişează <strong>arborele de navigare</strong> sus, într-un mod de distribuire pe diagonală.';
$txt['manual_pm_delete_button'] = 'Butonul principal <strong>Şterge cele selectate</strong> şi căsuţele de validare îţi permit să ştergi mesajele selectate, cu posibilitatea de a le selecta pe toate prin bifarea căsuţei de validare de sus.';
$txt['manual_pm_outbox_button'] = 'Link-ul <strong>Mesaje Trimise</strong> alternează cu căsuţa cu mesaje trimise, unde va fi evidenţiat ca şi cum link-ul <strong>Mesaje Primite</strong> ar fi acolo.';
$txt['manual_pm_new_msg2_part1'] = 'Butonul <strong>Mesaj Nou</strong> vă permite să începeţi un nou mesaj, ceea ce este similar cu';
$txt['manual_pm_new_msg2_link_posting_newtopic'] = ' deschiderea unui nou subiect de discuţie ';
$txt['manual_pm_new_msg2_part2'] = 'dar adaugă cămpurile \'Către:\' şi \'Bcc:\' (blind carbon copy/copie identică) şi opţiunea de a fi salvat în Mesaje trimise.';
$txt['manual_pm_reload'] = 'Iconiţa <strong>Schimbare vizualizare</strong> modifică amplasarea mesajelor pe pagină.';
$txt['manual_pm_sort_by'] = 'Link-urile <strong>Data</strong>, <strong>Tema subiectului</strong> şi <strong>De la</strong> îţi permit să ordonezi coloanele în funcţie de aceşti parametri (cu <strong>Data</strong> alternând între ordinea crescătoare şi descrescătoare, după cum indică mica săgeată).';
$txt['manual_pm_main_subject'] = 'Titlul principal duce la începutul mesajului, care va fi în continuare mai jos pe aceeaşi pagină.';
$txt['manual_pm_page_nos'] = 'Numerele paginilor duc către paginile următoare cu mesaje, dacă este cazul.';
$txt['manual_pm_start_reply'] = 'Postarea unui mesaj nou sau a unui răspuns la un mesaj';
$txt['manual_pm_how_to_start_reply_part1'] = 'Sunt de fapt mai multe metode de a scrie un mesaj privat nou, însă toate necesită să fii ';
$txt['manual_pm_how_to_start_reply_link_loginout'] = 'autentificat';
$txt['manual_pm_how_to_start_reply_part2'] = ': ';
$txt['manual_pm_msg_link_part1'] = 'Poţi urmări link-ul care zice ceva de genul \'Salut, [nume de utilizator], ai';
$txt['manual_pm_msg_link_link_interface'] = ' x mesaje';
$txt['manual_pm_msg_link_part2'] = ', x sunt noi\', apoi fă click pe butonul <strong>Mesaj Nou</strong> în căsuţa cu mesaje primite.';
$txt['manual_pm_click_name_part1'] = 'Poţi face click pe numele altui utilizator, urmat de <strong>Trimite acestui utilizator un mesaj privat</strong> în';
$txt['manual_pm_click_name_link_profile_info-all'] = 'profil';
$txt['manual_pm_click_name_part2'] = 'din ecranul de sumar.';
$txt['manual_pm_click_im_icon'] = 'Poţi începe un nou mesaj direct, făcând clic pe iconiţa <strong>IM conectat/deconectat</strong> care se găseşte în informaţiile despre utilizator care acompaniază mesajele acestuia.';
$txt['manual_pm_click_pm_icon_part1'] = 'Poţi scrie un mesaj nou direct dând click pe iconiţa <strong>MP autentificat/deconectat</strong> din <strong>Stare actuală</strong> în ';
$txt['manual_pm_click_pm_icon_link_profile_info-all'] = ' profil ';
$txt['manual_pm_click_pm_icon_part2'] = ' din ecranul de sumar. (Această iconiţă/link este de multe ori dublată în informaţiile despre utilizator descrise mai sus.)';
$txt['manual_pm_reply_msg_part1'] = 'A răspunde la un mesaj este foarte similar cu';
$txt['manual_pm_reply_msg_link_posting_reply'] = 'a răspunde la un subiect de discuţie';
$txt['manual_pm_reply_msg_part2'] = '. ';
$txt['manual_pm_messages'] = 'Mesaje';

// Entries for template: posting.
$txt['manual_posting_forum_about_part1'] = 'Deoarece scrierea de mesaje este în principiu motivul existenţei unui forum, vom acorda ceva timp studierii diferitelor opţiuni şi tehnici disponibile. Cei care sunt familiarizaţi cu softul forumului, HTML sau codul bulletin board în general ar putea prefera să treacă direct la ';
$txt['manual_posting_forum_about_link_bbcref'] = 'Codurile BBC - Bulletin Board Code';
$txt['manual_posting_forum_about_part2'] = ' şi ';
$txt['manual_posting_forum_about_link_bbcref_smileysref'] = 'Emoticoanele';
$txt['manual_posting_forum_about_part3'] = ' referinţele privind.';
$txt['manual_posting_please_note'] = '<strong>Vă rugăm să reţineţi că, întrucât forumul SMF poate fi particularizat pe scară largă de către administrator(i), prezentarea unei facilităţi în această documentaţie nu înseamnă neapărat că aceasta va fi disponibilă pentru toţi utilizatorii, în toate forumurile.</strong> ';
$txt['manual_posting_sec_posting_basics'] = 'Noţiuni de bază privind Scrierea de Mesaje ';
$txt['manual_posting_starting_topic'] = 'Deschiderea unui Subiect Nou de Discuţie';
$txt['manual_posting_starting_topic_desc_part1'] = 'Navigaţi către secţiunea în care doriţi să scrieţi şi faceţi click pe butonul <strong>Subiect Nou</strong> (poziţionat în mod implicit atât în partea de sus, cât şi în cea de jos a secţiunii, așa cum este indicat în ';
$txt['manual_posting_starting_topic_desc_link_index_message'] = 'Ajutor pentru Utilizatori - Introducere';
$txt['manual_posting_starting_topic_desc_part2'] = '), ceea ce ar trebui să te ducă în ecranul <strong>Deschide un subiect nou</strong>. Acesta prezintă o serie de opţiuni, două dintre cele mai importante fiind câmpul <strong>Subiect</strong> şi câmpul principal <strong>Mesaj</strong> (nu este etichetat astfel, însă este evident prin dimensiunea sa). Poţi deci începe să introduci titlul subiectului şi să tastezi (sau să copiezi) mesajul tău în zona principală de scriere, ţinând însă cont de faptul că un mesaj căruia îi lipseste titlul subiectului sau conţinutul nu va fi acceptat pentru postare până când nu le va avea pe amândouă. Dacă eşti mulţumit de cum arată mesajul în format text, poţi să-l postezi făcând click pe butonul <strong>Postare</strong> şi/sau poţi să-l previzualizezi mai intâi făcând click pe butonul <strong>Previzualizare</strong>, dar sunt şi alte ';
...
$txt['manual_posting_cat_name'] = 'Denumirea Categoriei';
$txt['manual_posting_board_name'] = 'Denumirea Secţiunii ';
$txt['manual_posting_start_topic'] = 'Deschide un subiect nou';
$txt['manual_posting_std_options'] = 'Opţiuni Standard';
$txt['manual_posting_add_options'] = 'Opţiuni Suplimentare';
$txt['manual_posting_omit_clarity'] = 'omise momentan pentru claritate şi explicate mai jos.';
$txt['manual_posting_subject'] = 'Subiect';
$txt['manual_posting_shortcuts'] = 'scurtături: tastează alt+s pentru a trimite un mesaj sau alt+p pentru previzualizare';
$txt['manual_posting_shortcuts_firefox'] = 'scurtături: loveşte shift+alt+s pentru a trimite/posta sau shift+alt+p pentru a previzualiza';
$txt['manual_posting_posts'] = 'Postare';
$txt['manual_posting_preview'] = 'Previzualizare';
$txt['manual_posting_nav_tree'] = 'Unele forumuri afişează <strong>arborele de navigare</strong> sus, într-un mod de economisire de spaţiu pe orizontală.';
...
$txt['manual_posting_start_poll'] = 'Deschiderea unui Sondaj Nou';
...
$txt['manual_posting_post_event'] = 'Postarea unui Eveniment în Calendar';
...
$txt['manual_posting_replying'] = 'Postarea unui răspuns la un Subiect de discuţie sau la un Sondaj';
$txt['manual_posting_replying_desc_part1'] = 'A răspunde la un subiect sau sondaj de opinie este în esenţă acelaşi lucru cu ';
$txt['manual_posting_replying_desc_link_newtopic'] = 'a deschide un subiect nou de discuţie';
...
$txt['manual_posting_quick_reply_link_bbc_smileys'] = 'Emoticoane';
$txt['manual_posting_quick_reply_part3'] = ' manually if you choose to use it.';
$txt['manual_posting_quote_post'] = 'Citarea unui mesaj postat';
...
$txt['manual_posting_modify_delete'] = 'Modificarea sau Ştergerea unui Mesaj Postat ';
...
$txt['manual_posting_sec_posting_options'] = 'Opţiuni Standard de Postare';
$txt['manual_posting_msg_icon'] = 'Iconiţa asociată mesajului';
...
$txt['manual_posting_exc_pt_icon'] = 'Semn de exclamare';
$txt['manual_posting_q_mark_icon'] = 'Semn de întrebare';
$txt['manual_posting_lamp_icon'] = 'Lampă';
$txt['manual_posting_smiley_icon'] = 'Zâmbet';
$txt['manual_posting_angry_icon'] = 'Mânios';
...
$txt['manual_posting_italicize_example'] = 'Înclinat';
$txt['manual_posting_underline_example'] = 'Subliniere';
$txt['manual_posting_strike_example'] = 'Tăiat';
$txt['manual_posting_glow_example'] = 'Strălucire';
$txt['manual_posting_shadow_example'] = 'Umbră';
$txt['manual_posting_move_example'] = 'Baner';
$txt['manual_posting_pre_example'] = 'Text Preformatat';
$txt['manual_posting_left_example'] = 'Aliniere la Stânga';
$txt['manual_posting_center_example'] = 'Centrat';
$txt['manual_posting_right_example'] = 'Aliniere la dreapta';
$txt['manual_posting_hr_example'] = 'Linie Orizontală';
$txt['manual_posting_size_example'] = 'Dimensiune Font';
$txt['manual_posting_face_example'] = 'Tip Font';
$txt['manual_posting_flash_example'] = 'Inserare Flash';
$txt['manual_posting_img_example'] = 'Inserare imagine';
$txt['manual_posting_url_example'] = 'Inserare Hyperlink';
$txt['manual_posting_email_example'] = 'Introduceţi adresa de e-mail';
$txt['manual_posting_ftp_example'] = 'Introduceţi Link-ul FTP';
$txt['manual_posting_table_example'] = 'Inserare Tabel';
$txt['manual_posting_tr_example'] = 'Inserare rând de tabel';
$txt['manual_posting_td_example'] = 'Inserare coloană de tabel';
$txt['manual_posting_sup_example'] = 'Indice sus';
$txt['manual_posting_sub_example'] = 'Indice sus';
$txt['manual_posting_tele_example'] = 'Teletype';
$txt['manual_posting_code_example'] = 'Introduceţi Codul';
$txt['manual_posting_quote_example'] = 'Introduceţi Citatul';
$txt['manual_posting_list_example'] = 'Inserare Listă';
$txt['manual_posting_Change_Color'] = 'Modificaţi Culoarea';
...
$txt['manual_posting_color_brown'] = 'Maro';
$txt['manual_posting_color_teal'] = 'Verde pal';
$txt['manual_posting_color_navy'] = 'Bleumarin';
$txt['manual_posting_color_maroon'] = 'Maro';
$txt['manual_posting_color_lime'] = 'Verde-lămâie';
...
$txt['manual_posting_angry_code'] = 'Mânios';
...
$txt['manual_posting_sub_message_icon'] = 'Iconiţa asociată mesajului';
...
$txt['manual_posting_sub_bbc'] = 'Codul BBC - Bulletin Board Code';
...
$txt['manual_posting_sub_smileys'] = 'Emoticoanele';
...
$txt['manual_posting_tags_desc_link_bbcref'] = 'butoane BBC';
...
$txt['manual_posting_return'] = 'Întoarceţi-vă la acest subiect de discuţie';
$txt['manual_posting_no_smiley'] = 'Nu utilizaţi emoticoanele.';
$txt['manual_posting_attach'] = 'Ataşaţi';
...
$txt['manual_posting_sub_return'] = 'Întoarceţi-vă la acest subiect de discuţie';
...
$txt['manual_posting_sub_no_smiley'] = 'Nu utilizaţi emoticoanele';
...
$txt['manual_posting_sub_attach'] = 'Ataşamentele';
...
$txt['manual_posting_sec_references'] = 'Referinţe';
...
$txt['manual_posting_bold_code'] = '[b]îngroşat[/b] ';
$txt['manual_posting_bold_output'] = 'îngroşat ';
$txt['manual_posting_bold_comment'] = '*';
$txt['manual_posting_bbc_italic'] = 'Înclinat';
$txt['manual_posting_italic_code'] = '[i]înclinat[/i]';
$txt['manual_posting_italic_output'] = 'înclinat';
$txt['manual_posting_italic_comment'] = '*';
$txt['manual_posting_bbc_underline'] = 'Subliniere';
$txt['manual_posting_underline_code'] = '[u]subliniere[/u] ';
$txt['manual_posting_underline_output'] = 'subliniere';
...
$txt['manual_posting_bbc_glow'] = 'Strălucire';
$txt['manual_posting_glow_code'] = '[glow=red,2,50]glow[/glow]';
$txt['manual_posting_glow_output'] = 'strălucire';
...
$txt['manual_posting_move_code'] = '[move]se mișcă[/move]';
$txt['manual_posting_move_output'] = 'se mișcă';
$txt['manual_posting_move_comment'] = 'Nu este XHTML valid, dar poate fi folosit şi pentru imagini!';
$txt['manual_posting_bbc_pre'] = 'Text Preformatat';
$txt['manual_posting_pre_comment'] = 'Pastrează formatarea textului important, redat în font monospace.';
$txt['manual_posting_bbc_left'] = 'Aliniere la Stânga';
$txt['manual_posting_left_code'] = '[left]aliniere la stânga[/left] ';
$txt['manual_posting_left_output'] = 'aliniere la stânga';
...
$txt['manual_posting_bbc_right'] = 'Aliniere la Dreapta';
$txt['manual_posting_right_code'] = '[right]aliniere la dreapta[/right] ';
$txt['manual_posting_right_output'] = 'aliniere la dreapta';
...
$txt['manual_posting_bbc_hr'] = 'Linie Orizontală';
$txt['manual_posting_hr_code'] = '[hr]';
$txt['manual_posting_hr_comment'] = '*';
$txt['manual_posting_bbc_size'] = 'Dimensiune Font';
$txt['manual_posting_size_code'] = '[size=10pt]dimensiunea fontului[/size] ';
...
$txt['manual_posting_bbc_flash'] = 'Inserare Flash';
$txt['manual_posting_flash_code'] = '[flash=200,200]<br />http://unsiteoarecare/unfișieroarecare.swf<br />[/flash]';
$txt['manual_posting_flash_output'] = 'http://unsiteoarecare/unfișieroarecare.swf';
...
$txt['manual_posting_bbc_img'] = 'Inserare Imagine';
$txt['manual_posting_img_top_code'] = '[img]<br />http://unsiteoarecare/imagine.gif<<br />[/img]';
$txt['manual_posting_img_top_comment'] = 'Introdu atributele width (lăţimea) şi height (înălţimea) pentru a redimensiona imaginea.';
$txt['manual_posting_img_bottom_code'] = '[img width=48 height=48]<br />http://unsiteoarecare/imagine.gif<br />[/img]';
$txt['manual_posting_bbc_url'] = 'Inserare Hyperlink';
$txt['manual_posting_url_code'] = '[url]http://unsiteoarecare/[/url]';
$txt['manual_posting_url_output'] = 'http://unsiteoarecare/';
...
$txt['manual_posting_url_bottom_code'] = '[url=http://unsiteoarecare/]<br />link descriptiv<br />[/url]';
$txt['manual_posting_url_bottom_output'] = 'link descriptiv';
$txt['manual_posting_bbc_email'] = 'Inserare Adresă de E-mail';
$txt['manual_posting_email_code'] = '[email]<br />cineva@unsiteoarecare<br />[/email]';
$txt['manual_posting_email_output'] = 'cineva@unsiteoarecare';
$txt['manual_posting_email_comment'] = '*';
$txt['manual_posting_bbc_ftp'] = 'Introduceţi Link-ul FTP';
$txt['manual_posting_ftp_code'] = '[ftp]<br />ftp://unsiteoarecare/unfișieroarecare<br />[/ftp]';
$txt['manual_posting_ftp_output'] = 'ftp://unsiteoarecare/unfișieroarecare';
$txt['manual_posting_ftp_comment'] = '*';
$txt['manual_posting_ftp_bottom_code'] = '[ftp=ftp://unsiteoarecare/unfișieroarecare]<br />link descriptiv<br />[/ftp]';
$txt['manual_posting_ftp_bottom_output'] = 'link descriptiv';
$txt['manual_posting_bbc_table'] = 'Inserare Tabel';
$txt['manual_posting_table_code'] = '[table][/table]';
$txt['manual_posting_table_comment'] = 'No meaningful output from the \'table\' tags alone.';
$txt['manual_posting_bbc_row'] = 'Inserare Rând de Tabel';
...
$txt['manual_posting_bbc_column'] = 'Inserare coloană de tabel';
...
$txt['manual_posting_bbc_code'] = 'Introduceţi Codul';
$txt['manual_posting_code_code'] = '[code]&lt;?php phpinfo(); ?&gt;[/code]';
$txt['manual_posting_code_comment'] = 'De folosit întotdeauna pentru a proteja codul formatat şi a împiedica interpretarea acestuia ca BBC şi/sau emoticoane!';
$txt['manual_posting_bbc_quote'] = 'Introduceţi Citatul';
$txt['manual_posting_quote_code'] = '[quote]citat[/quote] ';
$txt['manual_posting_quote_output'] = 'citat';
$txt['manual_posting_quote_comment'] = 'De observat atributul opţional \'autor\'.';
$txt['manual_posting_quote_buttom_code'] = '[quote author=author]citat[/quote] ';
$txt['manual_posting_quote_buttom_output'] = 'citat';
$txt['manual_posting_bbc_list'] = 'Introduceţi Lista';
...
$txt['manual_posting_list_buttom_output'] = '<ul class="normallist"><li style="list-style-type: circle;">cerc</li><li style="list-style-type: circle;">cerc</li><li style="list-style-type: circle;">cerc</li><li style="list-style-type: disc;">disc</li><li style="list-style-type: disc;">disc</li><li style="list-style-type: square;">pătrat</li><li style="list-style-type: square;">pătrat</li><li style="list-style-type: square;">pătrat</li></ul> ';
$txt['manual_posting_bbc_abbr'] = 'Abreviere';
...
$txt['manual_posting_smileys_help_img'] = 'Imagine (click pentru a o insera)';
$txt['manual_posting_smileys_help_code'] = 'Cod (tastaţi pentru a-l insera)';
...
$txt['manual_searching_sec_search'] = 'Începe o căutare';
...
$txt['manual_searching_search_desc_part2'] = '. Dacă nu, opţiunea <strong> Căutare</ strong> din meniul principal ar trebui să ducă direct la ecranul de căutare avansată.';
...
$txt['manual_searching_sec_simple_adv'] = 'Simplă sau Avansată ? ';
$txt['manual_searching_sub_simple'] = 'Căutarea Simplă ';
...
$txt['manual_searching_sub_adv'] = 'Căutarea Avansată ';
...
$txt['manual_searching_forum_name'] = 'Denumire Forum';
$txt['manual_searching_search'] = 'Căutare';
$txt['manual_searching_search_param'] = 'Setaţi Parametrii de Căutare';
$txt['manual_searching_search_for'] = 'Search for';
$txt['manual_searching_match_all'] = 'Potrivire cu toate cuvintele';
...
$txt['manual_searching_msg_age'] = 'Vechimea mesajului';
...
$txt['manual_searching_relevant_first'] = 'Rezultatele cele mai relevante mai întâi';
$txt['manual_searching_big_first'] = 'Subiectele cele mai mari mai întâi';
$txt['manual_searching_small_first'] = 'Subiectele cele mai mici mai întâi';
$txt['manual_searching_recent_first'] = 'Subiectele cele mai recente mai întâi';
$txt['manual_searching_oldest_first'] = 'Subiectele cele mai vechi mai întâi';
$txt['manual_searching_choose'] = 'Alegeţi o secţiune în care să căutaţi sau căutaţi în toate ';
$txt['manual_searching_cat'] = 'Denumire categorie';
$txt['manual_searching_board_name'] = 'Denumirea Secţiunii';
$txt['manual_searching_another_board'] = 'Altă Secţiune';
$txt['manual_searching_check_all'] = 'Verifică Tot';
...
$txt['manual_searching_three_options_part2'] = 'mai sus.';
...
$txt['manual_searching_search_button'] = 'Butonul <strong>Caută</strong> pune întregul motor de căutare în mişcare, dar apăsarea tastei  \\\'Enter\\\' direct din orice câmp de căutare este de multe ori mai convenabilă.';
