...
$txt['mailqueue_desc'] = 'В этом разделе Вы можете настраивать конфигурацию отсылки сообщений, а также просматривать текущую очередь сообщений и управлять ею, если это разрешено.';
...
$txt['mailqueue_clear_list_warning'] = 'Вы уверены, что хотите отправить все текущие сообщения в очереди? Это превысит все установленные ограничения.';
