...
$txt['permissionname_who_view'] = 'Просмотр "Кто онлайн"';
$txt['permissionhelp_who_view'] = 'Список "Кто онлайн" отображает пользователей, которые в данный момент находятся на форуме, а также их текущее действие или местоположение. Эти права доступа будут работать только если Вы включите их в \'Характеристиках и Настройках\'. Чтобы просмотреть этот список, нажмите на ссылку Кто онлайн, на главной странице. Если запретить, пользователи смогут просматривать список Кто онлайн, но не будут видеть, где находятся и что делают остальные пользователи.';
