...
$helptxt['manage_boards'] = '
    ...
    В этом меню Вы можете создавать/перемещать/удалять категории и разделы, содержащиеся в них.
	К примеру, если у Вас большой сайт, предоставляющий информацию о &quot;Спорте&quot;, &quot;Машинах&quot; и &quot;Музыке&quot;,
	то почти наверняка Категориями верхнего уровня, которые Вы создадите, будут категории именно с подобными названиями.
...
$helptxt['ban_members'] = '<strong>Бан пользователей</strong><br />
	...
	Вы можете выбрать тех пользователей, которых не хотите видеть на форуме. Как администратору, при просмотре сообщений Вам доступны IP-адреса всех пользователей.
	В списке ниже Вы просто указываете нужный IP-адрес, сохраняете его, и пользователи, использующие этот адрес, больше не смогут оставлять с него сообщения.<br />
	Кроме того, можно забанить пользователей по их электронным адресам.';

$helptxt['featuresettings'] = '<strong>Характеристики и настройки</strong><br />Здесь можно изменить некоторые настройки форума, в соответствии со своими предпочтениями.';

$helptxt['securitysettings'] = '<strong>Безопасность и модерирование</strong><br />В этой секции содержатся настройки безопасности и модерации вашего форума.';

$helptxt['modsettings'] = '<strong>Изменение настроек модификаций</strong><br />В этой секции содержатся настройки, добавленные модификациями, установленными на вашем форуме.';
...
$helptxt['time_format'] = '<strong>Формат времени</strong><br />
    У Вас есть большие возможности по изменению отображаемого формата времени.
    Преобразования производятся с помощью PHP-функции <strong>strftime</strong> и описываются ниже (более подробно можно прочитать по адресу <a href="http://www.php.su/functions/?strftime" target="_blank">php.su</a>).<br />
    <br />
...
$helptxt['warning_enable'] = '<strong>Система предупреждений пользователей</strong><br />
	...
	<ul class="normallist">
		<li>
			<strong>Уровень предупреждения - пользователь под наблюдением</strong><br />
		...
		<li>
			<strong>Уровень предупреждения - модерация сообщений</strong><br />
		...
		<li>
			<strong>Уровень предупреждения - пользователь молчит</strong><br />
...
$helptxt['error_log'] = '<strong>Лог ошибок</strong><br />
    ...
    кликнув по черной стрелке напротив каждой даты. Кроме того, Вы можете отфильтровать ошибки, кликнув по изображению рядом с каждой ошибкой. Это
    позволяет Вам фильтровать ошибки, к примеру, по пользователям. Когда фильтр включен, будут показаны только те результаты, которые соответствуют данному фильтру.';
$helptxt['theme_settings'] = '<strong>Настройки тем оформления</strong><br />
    Этот раздел позволяет Вам изменять настройки, относящиеся к теме оформления. Эти настройки включают такие параметры, как директория тем и URL-адреса, а также параметры, влияющие на отображение темы на вашем форуме. Большинство тем будут иметь различные параметры, настраиваемые пользователем, позволяющие адаптировать тему в соответствии с индивидуальными предпочтениями.';
$helptxt['smileys'] = '<strong>Смайлы и иконки</strong><br />
    ...
    Вы так же можете отредактировать иконки сообщений, если это разрешено на странице настроек.';
...
$helptxt['serversettings'] = '<strong>Настройки сервера</strong><br />
	Здесь Вы можете изменять основные настройки вашего форума. Этот раздел включает в себя настройки базы данных и URL-адресов, а также настройки отсылки сообщений и кэширование. Прежде чем изменять данные настройки, хорошенько подумайте — потому как неправильная настройка может привести форум в нерабочее состояние';
...
$helptxt['allow_guestAccess'] = 'Убрав здесь галочку, Вы запретите гостям делать что-либо, кроме базовых функций: вход, регистрация, напоминание пароля и пр. Это не то же самое, что запрет доступа гостям к форуму.';
...
$helptxt['mail_type'] = 'Эта настройка позволяет Вам выбрать установки PHP по умолчанию, или задать свои настройки SMTP. PHP не поддерживает SMTP-аутентификацию, так что, если Вам это нужно, выберите SMTP. Но помните, что SMTP может работать медленнее, и некоторые сервера не будут принимать имя пользователя и пароль.<br /><br />Вам не придется заполнять настройки SMTP, если Вы установили здесь настройки PHP по умолчанию.';
$helptxt['attachment_manager_settings'] = 'Вложения — это файлы, которые пользователи могут загружать на форум и прикреплять к своим сообщениям (для последующего просмотра/скачивания другими пользователями).<br /><br />
...
$helptxt['theme_install'] = 'Здесь Вы можете установить новую тему оформления. Вы можете установить её из уже существующей директории на сервере, загрузить с сайта, либо скопировать уже существующую тему и внести в её код нужные Вам изменения.<br /><br />Архив с темой или директория должны содержать файл <tt>theme_info.xml</tt>.';
...
$helptxt['securityDisable_why'] = 'Ваш текущий пароль. (который Вы используете для входа на форум.)<br /><br />Необходимость его ввода обусловлена тем, что Вы изменяете некоторые важные настройки и что изменяете их именно <strong>Вы</strong>, а не кто либо другой.';
...
// KeyCAPTCHA for SMF
$helptxt['keycaptcha_settings'] = 'Перед использованием данной модификации Вы должны зарегистрироваться на <a target="_blank" href="https://www.keycaptcha.com/accounts/reguser">сайте KeyCAPTCHA</a>.<br />На странице "Мои сайты" добавьте информацию о Вашем форуме, на котором установлена KeyCAPTCHA.<br />Все настройки для использования данной модифкации Вы можете найти в "Инструкции по установке" в Вашем бесплатнойм аккаунте на <a target="_blank" href="https://www.keycaptcha.com/sites/list/">сайте KeyCAPTCHA</a>';
...
$helptxt['customoptions'] = 'В этом разделе определены параметры, которые пользователь может выбирать из выпадающего списка. Есть несколько ключевых моментов, на которые стоит обратить внимание:
	<ul class="normallist">
		...
		<li><strong>Изменение порядка параметров:</strong> Можно изменить порядок параметров, перемещая текст между блокам. Но помните — Вы должны убедиться, что <strong>не</strong> изменили текст в результате данной операции.</li>
	</ul>';
...
$helptxt['pm_posts_verification'] = 'Данная настройка заставит пользователей вводить код, отображаемый на изображении, каждый раз при отправке личного сообщения. Пользователи, имеющие определенное количество сообщений не будут вводить код - это должно помочь в борьбе с автоматическими рассылками спама.';
...
$helptxt['password_strength'] = 'Эта функция определяет политику паролей пользователей.
    ...
    <ul class="normallist">
        ...
        <li><strong>Среднее:</strong> Пароль должен содержать как минимум 8 символов и не может совпадать с именем или email адресом.</li>
...
$helptxt['permissions_deny'] = 'Эта функция позволяет использовать запрещающие права для пользователей. Вы можете добавить группу с запрещающими правами для избранных пользователей.<br /><br />Используйте данную функцию с осторожностью.';
...
$helptxt['search_weight_length'] = 'При выборе варианта &quot;Релевантность поиска по величине темы&quot; Вы определяете процент отсеивания сообщений, первыми из которых будут составлять темы, с максимальным количеством сообщений, в которых имеется искомое слово или фраза.';
$helptxt['search_weight_subject'] = 'При выборе варианта &quot;Релевантность поиска по названию темы сообщений&quot; Вы определяете процент отсеивания сообщений, первыми из которых будут составлять темы, в названии которых будет содержаться искомое слово или фраза.';
$helptxt['search_weight_first_message'] = 'При выборе варианта &quot;Релевантность поиска по содержащимся первым сообщениям&quot; Вы определяете процент отсеивания тем, в первых сообщениях которых будет содержаться искомое слово или фраза.';
...
$helptxt['field_show_enclosed'] = 'Помещает форму для ввода текста пользователем между некоторым текстом или HTML. Это добавляет больше свободы при вводе сообщений, изображений или любых других встраиваемых объектов. Например:<br /><br />
		...
		Вы можете использовать следующие переменные:<br />
		<ul class="normallist">
...
$helptxt['ILA_InLineAttachments_help'] = '<b>Добавление вложений в текст сообщений</b><br />
		Образец:
		<br /><b>[attachimg=1 align=left width=400]</b>
		<br />Будет выведено изображение шириной 400 пикселов, выравненное по левому краю. За исключением первого тега и номера вложения все остальные параметры не обязательны
		<br /><b>[attach=1]</b>
		<br />В тексте сообщения появится миниатюра вложения (если это изображение). Если миниатюры не окажется, будет выведено полноразмерное изображение.
		<br /><br />
		<b>Параметры:</b>
		<br />attach=x, attachimg=x, attachurl=x, attachmini=x, где x — номер вложения
		<br />align=left, center, right
		<br />width=### (число в пикселах)
		<br />
        <h3>Доступные режимы</h3>
        <p>
            Вы можете выбирать различные режимы вставки вложений:
            <ul>
                <li><u>Миниатюра [attach=x]</u> Изображение будет отображаться в виде эскиза (превью)</li>
                <li><u>Полноразмерное изображение [attachimg=x]</u> Изображение будет отображаться в полный размер. Для слишком больших изображений будут использоваться полосы прокрутки</li>
                <li><u>Текстовая ссылка [attachurl=x]</u> В сообщении будет отображаться только ссылка на вложение, а также некоторые детали.</li>
                <li><u>Короткая текстовая ссылка [attachmini=x]</u> В сообщении будет отображаться только ссылка на вложение, без каких-либо деталей.</li>
            </ul>
        </p><br />
		<p>
			Вы можете выбирать тип выравнивания вложения внутри сообщения:
			<ul>
				<li><u>align=left</u> Изображение будет отображаться в левой части сообщения, текст — справа</li>
				<li><u>align=right</u> Изображение будет отображаться в правой части сообщения, текст — слева</li>
				<li><u>align=center</u> Изображение будет отображаться в центре сообщения, текст — ниже</li>
			</ul>
		</p><br />
		<p>
			Вы можете указывать ширину вложенных изображений:
			<ul>
				<li><u>width=123</u> Ширина отображаемого изображения будет изменена до 123 пикселов</li>
				<li>В случае указания ширины, превышающей реальную, будет использована максимально допустимая ширина, разрешенная на форуме</li>
				<li>Можно использовать уменьшение миниатюры, например [attach=1 width=50]
			</ul>
		</p><br />
        <h3>Как это использовать?</h3>
        <p>
            <h4>Шаг 1 :</h4>
            При создании сообщения выберите «Дополнительные опции», затем в секции «Вложение» укажите файл, который хотите загрузить;
            <h4>Шаг 2 :</h4>
            Укажите режим вставки в текст сообщения — выбрав одно из значений в раскрывающемся списке справа;
            <h4>Шаг 3 :</h4>
            Повторите предыдущие шаги для каждого вложения, которое захотите загрузить. Перемещайте и изменяйте теги в тексте вложения, как посчитаете нужным.
        </p>
';
