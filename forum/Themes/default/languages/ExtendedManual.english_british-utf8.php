...
$txt['manual_loginout_forgot_password'] = 'Forgotten your password?';
...
$txt['manual_reminders_describe'] = 'If a password is forgotten or lost, it can be reset by selecting the Forgotten your password? option from the login screen. The username or email address for the account is requested to begin the password reset process.';
...
$txt['manual_posting_please_note'] = '<strong>Please note that, because an SMF forum may be customised extensively by its administrator(s), the presence of a feature in this documentation does not necessarily mean that it will be available to all users in all forums.</strong>';
...
$txt['manual_posting_tags_desc_part2'] = 'and their purposes, let\'s see how they work by imagining that we want to post some text in bold type. While we can start by clicking the <strong>B</strong> (Bold) button and typing our text between the tags it produces, it\'s often more practical to type the text first, highlight it and then click the button. So typing \'text\', highlighting it and clicking the \'B\' button should produce \'[b]text[/b]\', which renders as <b>text</b> when posted or previewed. (NB This doesn\'t work in Opera, which inserts the tags at the end of the post.) Subsequently highlighting \'[b]text[/b]\' and clicking the <strong>I</strong> (Italicised) button will produce \'[i][b]text[/b][/i]\', which not only renders as <i><b>text</b></i> when posted or previewed but also introduces the concept of nesting, which means that each new set of tags in a case like this should be seen as a new \'box\' containing both the original text <em>and</em> any tags already applied to it.';
