...
$txt['package_manager_desc'] = 'С помощью менеджера пакетов Вы можете загружать и устанавливать различные пакеты модификаций для форума.';
$txt['installed_packages_desc'] = 'В этом разделе Вы можете просмотреть установленные на форуме пакеты модификаций, либо удалить те, которые Вам больше не нужны.';
...
$txt['package_installed_warning3'] = 'Пожалуйста, не забывайте делать резервное копирование файлов и базы данных, перед тем как устанавливать пакеты модификаций.';
...
$txt['corrupt_compatible'] = 'Пакет, который Вы пытаетесь загрузить или установить, поврежден или не совместим с установленной версией SMF.';
...
$txt['package_install_actions'] = 'Изменения, производимые пакетом';
...
$txt['package_will_fail_warning'] = 'По крайней мере, одна ошибка возникла при тестовой установке пакета.
        <strong>Настоятельно</strong> не рекомендуется продолжать дальнейшую установку, если Вы не уверены в своих действиях, или не произвели резервное копирование данных.
...
$txt['package_file_perms_warning_desc'] = '
	...
	<li>Перед настройкой прав убедитесь, что у Вас установлен FTP клиент, в случае возникновения ошибки Вы сможете ее исправить.</li>';
