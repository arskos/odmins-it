...
$txt['install_welcome_desc'] = 'Добро пожаловать в SMF. Этот скрипт проведет Вас через процесс установки %1$s. В течение нескольких следующих шагов от Вас потребуются некоторые детали, необходимые для установки, после чего форум будет готов к использованию.';
...
$txt['user_settings_username_info'] = 'Выберите имя, которое хотите использовать.<br />Внимание! Это имя в дальнейшем изменить нельзя! Вы сможете изменить только отображаемое имя.';
...
$txt['error_script_outdated'] = 'Программа установки устарела! Последняя версия SMF: %1$s, а ваша программа установки для %2$s.<br /><br />Рекомендуется посетить сайт <a href="http://www.simplemachines.org">Simple Machines</a> чтобы удостовериться, что Вы устанавливаете последнюю версию.';
...
$txt['error_db_filename_exists'] = 'База данных, которую Вы пытаетесь создать, уже существует. Пожалуйста, удалите существующий файл базы данных или введите другое имя.';
$txt['error_db_prefix_reserved'] = 'Указанный Вами префикс является зарезервированным. Пожалуйста, введите другой.';
