...
$txt['paid_subs_view_desc'] = 'Здесь Вы можете просмотреть все доступные подписки.';
...
$txt['paidsubs_test_desc'] = 'Перевод всех подписок в &quot;тестовый&quot; режим, в котором вся оплата будет производиться в песочнице PayPal. Не следует включать, если Вы не знаете, что делаете!';
...
$txt['paid_note'] = '<strong class="alert">Примечание:</strong><br />Для автоматически продляемых подписок необходимо установить адрес возвращения для каждого из способов оплаты. Для всех типов оплаты этот URL-адрес должен быть задан как:<br /><br />
	...
	Вы можете изменить ссылку на PayPal, кликнув <a href="https://www.paypal.com/us/cgi-bin/webscr?cmd=_profile-ipn-notify" target="_blank">здесь</a>.<br />
...
$txt['paid_mod_delete_warning'] = '<strong>ПРЕДУПРЕЖДЕНИЕ</strong><br /><br />При удалении этих подписок все подписанные на них пользователи потеряют предоставленные по подпискам права. Если Вы уверены в том, что делаете, то просто отключите подписки, не удаляя их.<br />';
...
$txt['paid_count_not_find_subscription_log'] = 'Обработчик подписки не может найти запись в журнале подписки для пользователя с ID: %1$s, ID подписки: %2$s';
...
$txt['pending_payments_desc'] = 'Данный пользователь пытается внести следующие платежи за подписку, но форумом не было получено подтверждения. Если Вы уверены, что платеж поступил, нажмите кнопку &quot;Принять&quot; в действиях для подписки. Либо Вы можете нажать кнопку &quot;Удалить&quot; для уничтожения всех ссылок по оплате.';
