...
$txt['utf8_warning'] = 'Если Вы хотите преобразовать базу данных в UTF-8, ознакомьтесь со следующей информацией:
<ul>
...
$txt['utf8_cannot_convert_fulltext'] = 'В таблице messages используется полнотекстовый индекс (применяется при поиске). Вы не сможете продолжить конвертацию в UTF-8, пока не удалите этот индекс. После конвертации индекс можно создать повторно.';
...
$txt['maintain_karma_points_info2'] = 'а так же удалить все описания изменений кармы';
