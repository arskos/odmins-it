...
$txt['site']='odmins-it';
$txt['slax']='Slax - собери свою собственную, карманную ОС';
...
$txt['notify_request'] = 'Хотите получать уведомление по email при появлении новых ответов в этой теме?';
// Use numeric entities in the below string.
...
$txt['sendtopic_title'] = 'Отправить ссылку на тему &quot;%1$s&quot; другу.';
...
$txt['try_again'] = 'Пожалуйста, повторите еще раз. Если ошибка продолжает повторяться, обратитесь к Администратору.';
$txt['file'] = 'Файл';
$txt['line'] = 'Строка';
// Use numeric entities in the below string.
$txt['tried_to_repair'] = 'SMF обнаружил и пытается автоматически исправить ошибку в вашей базе данных. Если проблема осталась или Вы продолжаете получать письма, пожалуйста, обратитесь к своему хостеру.';
...
$txt['template_parse_error_message'] = 'Возможно, что-то случилось с системой шаблонов на форуме. Это временная проблема, пожалуйста, возвращайтесь чуть позже и попробуйте снова. Если Вы увидите это сообщение снова, обратитесь к Администратору форума.<br /><br />Вы также можете попробовать <a href="javascript:location.reload();">обновить страницу</a>.';
$txt['template_parse_error_details'] = 'Проблема с загрузкой <tt><strong>%1$s</strong></tt> шаблона или языкового файла.  Пожалуйста, проверьте синтаксис и попробуйте снова — запомните, одинарные кавычки (<tt>\'</tt>) должны экранироваться слэшем (<tt>\\</tt>). Чтобы увидеть более подробную информацию об ошибке PHP, попытайтесь <a href="' . $boardurl . '%1$s">запустить непосредственно сам файл</a>.<br /><br />Также Вы можете <a href="javascript:location.reload();">обновить страницу</a> или <a href="' . $scripturl . '?theme=1">использовать тему по умолчанию</a>.';
...
// KeyCAPTCHA for SMF
$txt['keycaptcha_task_header'] = 'Анти-спам';
$txt['keycaptcha_task_explain'] = 'выполните задание';
$txt['keycaptcha_message_noscript'] = 'Вы должны разрешить JavaScript в Вашем браузере. После этого, пожалуйста, перезагрузите страницу. Без этого, к сожалению, Вы не сможете отправлять сообщения.';
...
$txt['send_email_disclosed'] = 'Обратите внимание: Ваш e-mail будет виден получателю.';
