...
$txt['modlog_ac_remind_member'] = 'Отправлено уведомление пользователю &quot;{member}&quot; для активации учетной записи';
$txt['modlog_ac_approve_member'] = 'Одобрена/Активирована учетная запись пользователя &quot;{member}&quot;';
$txt['modlog_ac_newsletter'] = 'Произведена рассылка';

$txt['modlog_ac_install_package'] = 'Установлен новый пакет: &quot;{package}&quot;, версии {version}';
$txt['modlog_ac_upgrade_package'] = 'Обновлен пакет: &quot;{package}&quot; на версию {version}';
$txt['modlog_ac_uninstall_package'] = 'Удален пакет: &quot;{package}&quot;, версии {version}';
