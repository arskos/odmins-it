...
function template_info_center()
{
		...
		elseif (!empty($context['latest_posts']))
		{
			echo '
				<table align="center" cellpadding="5" cellspacing="0" width="100%" border="0">
        			<tr>
                        <td class="arp_header" width="40%">', $txt['topic_name'] ,':</td>
                        <td class="arp_header" width="10%">', $txt['poster_name'] ,':</td>
		              	<td class="arp_header" width="20%">', $txt['board_name'] ,':</td>
                        <td class="arp_header" width="30%">', $txt['post_time'] ,':</td>
                    </tr>';
	...
	if ($settings['show_stats_index'])
	{
		if (!empty($modSettings['karmadescmod']) && !empty($modSettings['karmalastchange']) && $context['show_karmastat'] && empty($modSettings['karmaisowner']) && (!empty($modSettings['karmapermiss'])) && ($context['user']['is_admin']!=1))
		{
		echo '
		<div class="title_barIC">
			<h4 class="titlebg">
