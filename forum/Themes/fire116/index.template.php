	...
	echo '
		  <div id="footer">
			  <div id="footer-l">
					<div id="footer-r">
			<div id="footerarea">
				<span class="smalltext">', theme_copyright(), '<br /><font color="#757575">Theme </font><font color="#858585"><b>Fire By</b></font> <a href="http://www.fussilet.com" target="_blank">Fussilet</a></span>';
