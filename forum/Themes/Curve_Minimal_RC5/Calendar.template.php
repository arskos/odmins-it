...
function template_show_month_grid($grid_name)
{
	...
	if (empty($calendar_data['disable_title']))
	{
		echo '
			<div class="cat_bar">
				<h3 class="catbg centertext" style="font-size: ', $calendar_data['size'] == 'large' ? '1.3em' : 'small', ';">';
	...
	foreach ($calendar_data['weeks'] as $week)
	{
		...
		foreach ($week['days'] as $day)
		{
			...
			echo '
						<td style="height: ', $calendar_data['size'] == 'small' ? '20' : '80', 'px; padding: 2px;', $calendar_data['size'] == 'small' ? 'font-size: x-small;' : '', '" class="', $day['is_today'] ? 'calendar_today' : 'windowbg', ' days">';
