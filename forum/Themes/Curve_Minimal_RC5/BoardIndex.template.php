...
function template_main()
{
	...
	foreach ($context['categories'] as $category)
	{
		...
		if (!$category['is_collapsed'])
		{
				echo '
				<tr>
					<th class="windowbg3"></th>
					<th class="windowbg3 smalltext">', $txt['board'], '</th>
					<th class="windowbg3 smalltext">' , $txt['posts'] , '</th>
					<th class="windowbg3 smalltext">', $txt['board_topics'], '</th>
					<th class="windowbg3 smalltext">', $txt['last_post'], '</th>
				</tr>';
				...
				if (!empty($board['children']))
				{
					...
					foreach ($board['children'] as $child)
					{
						if (!$child['is_redirect'])
							$child['link'] = '<a href="' . $child['href'] . '" class="subject' . ($child['new'] ? ' new_posts" ' : '') . '" title="' . ($child['new'] ? $txt['new_posts'] : $txt['old_posts']) . ' (' . $txt['board_topics'] . ': ' . comma_format($child['topics']) . ', ' . $txt['posts'] . ': ' . comma_format($child['posts']) . ')">' . $child['name'] . ($child['new'] ? '</a> <a href="' . $scripturl . '?action=unread;board=' . $child['id'] . '" title="' . $txt['new_posts'] . ' (' . $txt['board_topics'] . ': ' . comma_format($child['topics']) . ', ' . $txt['posts'] . ': ' . comma_format($child['posts']) . ')"><img src="' . $settings['lang_images_url'] . '/new.gif" class="new_posts" alt="" />' : '') . '</a>';
						else
							$child['link'] = '<a  class="subject" href="' . $child['href'] . '" title="' . comma_format($child['posts']) . ' ' . $txt['redirects'] . '">' . $child['name'] . '</a>';
					...
					echo '<div class="sub_boards"><img src="' . $settings['images_url'] . '/arrow.gif" alt="">' . implode('<br /><img src="' . $settings['images_url'] . '/arrow.gif" alt="">', $children) , '</div>';
				}
