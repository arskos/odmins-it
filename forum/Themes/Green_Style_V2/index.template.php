...
<div align="center"><img src="', $settings['theme_url'], '/images/logo.jpg" width="100%" height="191" /></div>
...
function template_body_below()
{
	...
	<div id="footer_section"><div class="frame">
		<ul class="reset">
			...
			<li><a href="http://www.skinmod.es" target="_blank"><span>Green Style V2 by kenet</span></a></li>
