	...
	while ($message = $context['get_message']())
	{
      ...
      // Show the member's custom title, if they have one.
		if (!empty($message['member']['title']))
			echo '
								<div class="windowbg4"><li class="title">', $message['member']['title'], '</li></div>';

		// Show the member's primary group (like 'Administrator') if they have one.
		if (!empty($message['member']['group']))
			echo '
								<div class="windowbg4"><li class="membergroup">', $message['member']['group'], '</li></div>';
		...
		if (!$message['member']['is_guest'])
		{
			...
			if ((empty($settings['hide_post_group']) || $message['member']['group'] == '') && $message['member']['post_group'] != '')
				echo '
								<div class="windowbg4"><li class="postgroup">', $message['member']['post_group'], '</li></div>';
			echo '
								<div class="windowbg4"><li class="stars">', $message['member']['group_stars'], '</li></div>';

			// Show avatars, images, etc.?
			if (!empty($settings['show_user_images']) && empty($options['show_no_avatars']) && !empty($message['member']['avatar']['image']))
				echo '
								<div class="windowbg4"><li class="avatar" style="overflow: auto;">', $message['member']['avatar']['image'], '</li></div>';

			// Show how many posts they have made.
			if (!isset($context['disabled_fields']['posts']))
				echo '
								<div class="windowbg4"><li class="postcount">', $txt['member_postcount'], ': ', $message['member']['posts'], '</li></div>';

			// Is karma display enabled?  Total or +/-?
			if ($modSettings['karmaMode'] == '1')
				echo '
								<div class="windowbg4"><li class="karma">', $modSettings['karmaLabel'], ' ', $message['member']['karma']['good'] - $message['member']['karma']['bad'], '</li></div>';
			...
			if ($message['member']['karma']['allow'])
				echo '
								<div class="windowbg4"><li class="karma_allow">
			...
			if (!empty($settings['show_blurb']) && $message['member']['blurb'] != '')
				echo '
								<div class="windowbg4"><li class="blurb">', $message['member']['blurb'], '</li></div>';
			...
			if (!empty($message['member']['custom_fields']))
			{
				...
				foreach ($message['member']['custom_fields'] as $custom)
				{
					...
					if (empty($shown))
					{
						$shown = true;
						echo '
								<div class="windowbg4"><li class="im_icons">
									<ul>';
					}
					echo '
										<li>', $custom['value'], '</li>';
			...
			{
				echo '
								<div class="windowbg4"><li class="profile">								
                           <ul>';
