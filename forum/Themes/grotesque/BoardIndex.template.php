...
// Show some statistics next to the link tree if SP1 info is off.
	...
	<div class="tborder" style="margin-top: ' , $first ? '0;' : '1ex;' , '' , $context['browser']['needs_size_fix'] && !$context['browser']['is_ie6'] ? 'width: 100%;' : '', '">
		...
		{
			echo '
		<table border="0" width="100%" cellspacing="1" cellpadding="5" style="margin-top: 1px;">';
			...
			<tr>
				...
				elseif ($board['children_new'])
					echo '<img src="', $settings['images_url'], '/on2.png" alt="', $txt[333], '" title="', $txt[333], '" />';
	...
	<table border="0" width="100%" cellspacing="0" cellpadding="0">
		<tr>
			<td class="titlebg" align="center" valign="middle">
				<img src="' . $settings['images_url'] . '/new_some.png" alt="No New Posts" align="middle" /> ', $txt[333], '
				<img src="' . $settings['images_url'] . '/new_child.png" alt="New Posts in Child Board" align="middle" /> ', $txt[334], '
				<img src="' . $settings['images_url'] . '/new_none.png" alt="New Posts" align="middle" /> ', $txt[335], '
			</td>
		</tr>
	</table>';
	}
