	...
	if (!$pre_query || !empty($topic_ids))
	{
		...
		while ($row = $smcFunc['db_fetch_assoc']($result))
		{
			...
			$context['topics'][$row['id_topic']] = array(
				...
				'views_link' => allowedTo('tvl_view_any') || (allowedTo('tvl_view_own') && $row['first_id_member'] == $user_info['id']) ? '<a href="' . $scripturl . '?action=topicviewlog;topic=' . $row['id_topic'] . '">' . $row['num_views'] . '</a>' : $row['num_views'],
