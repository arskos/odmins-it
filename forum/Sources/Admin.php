...
function AdminMain()
{
	...
	$modSettings['integrate_admin_include'] = $modSettings['integrate_admin_include'].",\$sourcedir/Subs-Tapatalk.php";
...
function AdminSearchInternal()
{
	...
	*/
	...
	$settings_search = array(
		...
		array('ModifyCacheSettings', 'area=serversettings;sa=cache'),		array('TrackerAdminSettings', 'area=trackersettings'),
