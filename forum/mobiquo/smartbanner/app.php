...
$image_list = array(
    ...
    'full_view_add_v3_iOS.png','full_view_add_v3_Android.png', 'full_view_add_v3_line.png'
);
...
<script>
    $(document).ready(function()
    {
        ...
        //      });
        // }
        $("#button1 a").attr("href", '<?php echo addslashes(str_replace("&amp;","&",htmlspecialchars($app_redirect_link , ENT_QUOTES, "UTF-8")))?>');
        ...
        $("#button3 a").attr("href", '<?php echo addslashes(str_replace("&amp;","&",htmlspecialchars($redirect_url, ENT_QUOTES, "UTF-8")))?>');
    })
</script>
</head>
<body scroll="no">
